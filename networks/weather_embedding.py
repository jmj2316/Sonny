...
from sonny.pos_embed import get_2d_sincos_pos_embed, get_1d_sincos_pos_embed_from_grid
...
class WeatherEmbedding(nn.Module):
    ...
    def initialize_weights(self):
        ...
        self.channel_embed.data.copy_(torch.tensor(channel_embed, dtype=torch.float32).unsqueeze(0))
